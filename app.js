document.addEventListener('DOMContentLoaded', () => {
    ...
    const items = [
        { name: "🍉 Арбуз", image: "images/items/watermelon.png", flavor: "Сочный летний вкус",rarity: "legendary", probability: 0.2 },
        { name: "🔋 Энергетик", image: "images/items/energy.png", flavor: "Заряд бодрости", rarity: "legendary", probability: 0.2 },
        { name: "🍑 Персик", image: "images/items/peach.png", flavor: "Нежная сладость", rarity: "legendary", probability: 0.2 },
        { name: "🍏 Яблоко", image: "images/items/apple.png", flavor: "Классическая свежесть", rarity: "legendary", probability: 0.2 },
        { name: "🍓 Клубника", image: "images/items/strawberry.png", flavor: "Ягодный взрыв", rarity: "legendary", probability: 0.2 },
        { name: "🎈 Бабл-Гам", image: "images/items/bubblegum.png", flavor: "Детская радость", rarity: "legendary", probability: 0.2 },
        { name: "🫐 Ежевика", image: "images/items/blackberry.png", flavor: "Терпкая глубина", rarity: "legendary", probability: 0.2 },
        { name: "🍇 Виноград", image: "images/items/grape.png", flavor: "Виноградный коктейль", rarity: "legendary", probability: 0.2 },
        { name: "🥶 Холодок", image: "images/items/ice.png", flavor: "Ледяная свежесть", rarity: "legendary", probability: 0.2 },
        { name: "🍒 Вишня", image: "images/items/cherry.png", flavor: "Терпкая сладость", rarity: "legendary", probability: 0.2 },
        { name: "🫐 Черника", image: "images/items/blueberry.png", flavor: "Лесная ягода", rarity: "legendary", probability: 0.2 },
        ...
        { name: "Ничего", image: "images/items/nothing.png", flavor: "Попробуйте еще раз!", rarity: "nothing", probability: 68.8 },
    ...
    // Application state
    const state = {
        balance: localStorage.getItem('balance') ? parseInt(localStorage.getItem('balance')) : 2,
        isOpening: false,
